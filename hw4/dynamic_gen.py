...
for run in range(50):
    ...
    tree.write('dragonfly.xml')

    # create model and data
    model = mj.MjModel.from_xml_path('dragonfly.xml')
    ...
    if fitness > most_fit_fitness:
        # save this xml
        tree.write('most_fit_parent3.xml')
...
plt.title('Fitness of Dynamically Generated Organisms Round 3')
# plt.show()
...
ax.set_title('Comparison of Average Values to Most Fit Organism Round 3')
...
print("Saved most fit organism to most_fit_df.xml!")